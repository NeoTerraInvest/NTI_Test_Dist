export const kor = {
  about: `
NTI는 새로운 땅이라는 의미를 담고 있으며, 
이는 우리가 추구하는 비전과 가치의 핵심입니다. 
Neo Terra는 단순한 지리적 개념을 넘어, 
기존의 틀을 깨고 미래로 나아가는 새로운 기회와 가능성의 공간을 상징합니다. 
변화하는 시장 속에서 우리는 끊임없이 새로운 투자와 
혁신적인 아이디어를 통해 한계를 넘어 지속 가능한 성장을 이루고자 합니다.`,
  start: `새로운 도전과 확장의 공간이며, 혁신을 통해 세상에 긍정적인 변화를 이끌어가는 기반입니다.`,
  newInvest: `우리는 전통적인 투자 방식에서 벗어나, 미래를 위한 혁신적이고 창의적인 투자에 집중합니다. `,
  newglobal: `기술, 환경, 지속 가능성을 고려한 전략적 투자를 통해 글로벌 시장에서 영향력을 확대해 나갑니다.`,
  adventure: `빠르게 변화하는 시장에서 유연하고 민첩하게 움직이며, 새로운 시장을 선도합니다.`,
  create: `도전을 두려워하지 않고, 가치 창출을 위해 끊임없이 고민하고 실행합니다.`,
  trust: `고객과의 신뢰를 바탕으로 지속 가능한 성장을 추구합니다.`,
  value: `사회와 환경을 고려한 책임 있는 투자로 더 나은 미래를 만듭니다.`,
};

export const eng = {
  about: `NTI embodies the meaning of "New Land," 
which lies at the core of our vision and values. 
Neo Terra goes beyond a simple geographical concept. 
